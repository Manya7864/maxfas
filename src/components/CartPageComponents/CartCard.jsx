...
const CartCard = ({ ele }) => {
  ...
  const handle_quantity = (e) => {
    ...
    fetch(
      "https://maxfashion-mqjb.onrender.com/max-fashion/cart/quantity",
      {
        method: "PATCH",
        body: JSON.stringify({
      ...
      .then(async (data) => {
        ...
        if (!error) {
          fetch(
            `https://maxfashion-mqjb.onrender.com/max-fashion/cart/${store.AppReducer.user._id}`
          )
            .then((res) => res.json())
            .then((data) => {
  ...
  const handle_delete = () => {
    fetch(
      `https://maxfashion-mqjb.onrender.com/max-fashion/cart/${ele.user_id}/${ele.product_id}`,
      { method: "DELETE" }
    )
      .then((res) => res.json())
      .then(async (data) => {
